		...
		<div class="card">
			<div class="card-body login-card-body">
				<div class="login-logo">
					<a href="login.php">
						<font color="blue">
							<H1>THRIFT ID</H1><h3>SYSTEM
						</font>
					</a>
				</div>
				<center>
					<img src="dist/img/logo-ic.png" width=180px />
					<br>
					<br>
				</center>
				<form action="" method="post">
					...
					<div class="row">
						<div class="col-12">
							<button type="submit" class="btn btn-primary btn-block btn-flat" name="btnLogin" title="Login">
								<b>Masuk</b>
							</button>
						</div>
				</form>
